...
public class Question implements Comparable<Question>, Serializable {
    ...
    private Tree                intermediateTree;                        // an optionally transformed or simplified copy of the source tree (the
                                                                          // output of stage 1)
    ...
    private Object              sourceDocument;                          // generic pointer to a document object (generic in order to avoid unneeded
                                                                          // dependencies)
