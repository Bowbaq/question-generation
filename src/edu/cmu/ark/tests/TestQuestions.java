 ...
 * List<String> res = qt.getQuestionsFromParse(
 * "(ROOT (S (NP (NNP PERSON-0)) (VP (VBD was) (ADJP (JJ able) (S (VP (TO to) (VP (VB understand) (NP (DT the) (NN question)) (PP (IN after) (S (VP (VBG reading) (PP (IN through) (NP (DT the) (NN book)))))))))) (NP (ADVP (NP (CD one)) (JJR more)) (NN time))) (. .)))"
 * );
 * assertTrue(res.toString(),(res.size()==2));
 ...
 * qt.putEntityString("PERSON-0", "John");
 * List<String> res =
 * qt.getQuestionsFromParse("(ROOT (S (NP (NNP PERSON-0)) (VP (VBD ran) (ADVP (RB as) (RB quickly)) (PP (IN as) (NP (DT a) (NN deer)))) (. .)))");
 * assertTrue(res.toString(),(res.size()==3));
